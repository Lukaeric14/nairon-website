...
export const DESIGN_ENGINEER_ROLE: CareerRole = {
	...
	compensation: "TBD",
	summary:
		"A 3-month internship for frontend builders who care about interface taste, product clarity, and using AI to move from vague ideas to working software quickly.",
	whyNairon: [
		{
			label: "Build the interface layer for AI employees",
			text: "Nairon builds AI employees around real business workflows. You will help make those systems understandable, useful, and sharp enough for customers to trust.",
		},
		{
	...
	work: [
		"Craft polished, responsive interfaces for Nairon products and internal AI workflows.",
		"Turn messy product ideas into clear screens, prototypes, flows, and production-ready frontend code.",
	...
	teamReasons: [
		...
		"You will work at the intersection of product, design, engineering, and AI-native workflows.",
	...
	applicationPrompts: [
		"How you currently use AI when building interfaces",
