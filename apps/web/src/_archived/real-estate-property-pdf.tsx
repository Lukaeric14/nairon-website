			...
			<div className="min-h-screen bg-white text-[#1A1916] font-inter">
				...
				<div className="pt-16 mt-12 md:mt-16 relative overflow-hidden">
					...
					<div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
						...
						<div
							className="absolute hidden lg:block rounded-xl overflow-hidden shadow-2xl border border-[#0C0C0C]/10 transition-all duration-500 ease-out cursor-pointer pointer-events-auto z-[1] hover:z-50 hover:-translate-y-8 hover:shadow-[0_20px_60px_rgba(201,169,110,0.15)] hover:scale-105"
							style={{
								width: 220,
								height: 290,
								top: 60,
						...
						>
							...
							/>
							<div className="bg-[#F5F3EE] px-4 py-3 h-[42%]">
								<div className="h-1.5 w-16 bg-[#C9A96E]/50 rounded mb-2" />
								<div className="h-2.5 w-3/4 bg-[#0C0C0C]/20 rounded mb-1.5" />
								<div className="h-2 w-1/2 bg-[#0C0C0C]/10 rounded mb-3" />
								<div className="h-1 w-full bg-[#0C0C0C]/[0.06] rounded mb-1" />
								<div className="h-1 w-full bg-[#0C0C0C]/[0.06] rounded mb-1" />
								<div className="h-1 w-2/3 bg-[#0C0C0C]/[0.06] rounded" />
							</div>
						</div>
						{/* Left stack — front card (lower, offset) */}
						<div
							className="absolute hidden lg:block rounded-xl overflow-hidden shadow-2xl border border-[#0C0C0C]/10 transition-all duration-500 ease-out cursor-pointer pointer-events-auto z-[2] hover:z-50 hover:-translate-y-8 hover:shadow-[0_20px_60px_rgba(201,169,110,0.15)] hover:scale-105"
							style={{
								width: 220,
								height: 290,
								top: 240,
						...
						>
							...
							<div className="bg-[#F5F3EE] px-4 py-3 h-[42%]">
								...
								<div className="h-2.5 w-2/3 bg-[#0C0C0C]/20 rounded mb-1.5" />
								<div className="h-2 w-1/3 bg-[#0C0C0C]/10 rounded mb-3" />
								<div className="h-1 w-full bg-[#0C0C0C]/[0.06] rounded mb-1" />
								<div className="h-1 w-full bg-[#0C0C0C]/[0.06] rounded" />
							</div>
						</div>
						...
						>
							...
							<div className="bg-[#F5F3EE] px-4 py-3 h-[42%]">
								...
								<div className="grid grid-cols-2 gap-2 mt-1">
									<div className="h-7 bg-[#0C0C0C]/[0.04] rounded" />
									<div className="h-7 bg-[#0C0C0C]/[0.04] rounded" />
								</div>
							</div>
						</div>
					...
					<div className="px-6 md:px-12 py-16 md:py-24 max-w-4xl mx-auto text-center relative z-10">
						...
						<h1
							className="font-normal tracking-[-2px] md:tracking-[-3px] text-[#1A1916]"
							style={{
						...
						<p className="mt-5 text-[#5C584F] text-base md:text-lg leading-relaxed max-w-xl mx-auto">
					...
					{/* How it works */}
					<div className="border-t border-[#0C0C0C]/[0.06] px-6 md:px-12 py-16 md:py-24 max-w-4xl mx-auto">
						...
						<div className="grid md:grid-cols-3 gap-8 md:gap-12 mt-10">
							{[
								...
								<div key={step.num} className="text-center">
									...
									<h3 className="text-[#1A1916] text-lg font-semibold mt-2 mb-2">
										{step.title}
									</h3>
					...
					{/* CTA */}
					<div className="border-t border-[#0C0C0C]/[0.06] px-6 md:px-12 py-16 md:py-24 text-center">
						<h2 className="text-[24px] md:text-[36px] font-normal tracking-[-1px] text-[#1A1916] max-w-2xl mx-auto">
							Ready to Automate{" "}
							<span className="font-serif italic text-[#C9A96E]">
								More of Your Business?
							</span>
						</h2>
						<p className="mt-4 text-[#5C584F] text-base leading-relaxed max-w-lg mx-auto">
...
const inputCls =
	"w-full bg-[#0C0C0C]/[0.04] border border-[#0C0C0C]/[0.08] rounded-xl px-4 py-4 text-[#1A1916] text-base placeholder:text-[#5C584F]/30 outline-none focus:border-[#C9A96E]/40 focus:ring-1 focus:ring-[#C9A96E]/20 transition-all"
...
function InputForm({
	...
	return (
		<form onSubmit={onSubmit} className="space-y-5">
			<div>
				<label className="text-[#5C584F] text-sm mb-2 block">
					Zillow Listing URL
				</label>
				<div className="relative">
					<Link2 className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#5C584F]/50" />
					<input
						type="url"
						value={url}
			...
			<div className="flex flex-col items-center gap-2 text-center">
				...
				<a
					...
					target="_blank"
					rel="noreferrer"
					className="inline-flex items-center gap-2 rounded-full border border-[#0C0C0C]/[0.1] bg-[#0C0C0C]/[0.03] px-4 py-2.5 text-sm font-medium text-[#1A1916] transition-all hover:border-[#C9A96E]/40 hover:bg-[#C9A96E]/8 hover:text-[#1A1916]"
				>
					View Example Deck
...
function ProcessingState({
	...
	return (
		<div className="flex flex-col items-center justify-center py-16">
						...
						>
							...
							<span
								className={`text-sm tabular-nums ${
									isCurrent ? "text-[#1A1916]" : "text-[#5C584F]"
								}`}
							>
								{label}
							</span>
			...
			<p className="text-[#5C584F]/40 text-xs mt-6 tabular-nums">
			...
			{showEmailPrompt && !emailSubmitted && currentStatus !== "completed" && (
				<div className="mt-8 w-full max-w-sm animate-in fade-in slide-in-from-bottom-2 duration-500">
					<div className="rounded-xl border border-[#0C0C0C]/[0.08] bg-[#0C0C0C]/[0.02] p-5">
						...
						>
							<input
								...
								className="flex-1 bg-[#0C0C0C]/[0.04] border border-[#0C0C0C]/[0.08] rounded-lg px-3 py-2.5 text-[#1A1916] text-sm placeholder:text-[#5C584F]/30 outline-none focus:border-[#C9A96E]/40"
							/>
							<button
								type="submit"
						...
						<p className="text-[#5C584F]/30 text-[10px] mt-2">
							No spam. Ever.
						</p>
					</div>
				</div>
...
function ErrorState({
	...
	return (
		<div className="flex flex-col items-center justify-center py-16">
			...
			<p className="text-[#1A1916] text-base font-medium mb-2">
				Something went wrong
			</p>
			<p className="text-[#5C584F] text-sm text-center max-w-md mb-6">
				{message}
			</p>
			<button
				type="button"
...
function ReadyState({
	...
	return (
		<div className="space-y-6">
			{/* Preview card */}
			<div className="rounded-xl border border-[#0C0C0C]/[0.08] overflow-hidden">
				{listing.images[0] && (
					<div className="relative h-48 md:h-64 overflow-hidden">
						...
						<div className="absolute bottom-4 left-5 right-5">
							<p className="text-[#1A1916] text-lg md:text-xl font-semibold">
								{listing.address || "Property"}
							</p>
							{location && (
								<p className="text-[#1A1916]/60 text-sm">{location}</p>
							)}
						</div>
					</div>
				)}

				<div className="p-5 md:p-6 bg-[#0C0C0C]/[0.02]">
					{/* Stats row */}
					<div className="flex items-center gap-6 mb-4">
						...
						<div className="flex items-center gap-4 text-[#5C584F] text-sm">
					...
					<button
						type="button"
						onClick={onReset}
						className="w-full mt-3 text-[#5C584F] text-sm hover:text-[#1A1916] transition-colors text-center py-2"
					>
