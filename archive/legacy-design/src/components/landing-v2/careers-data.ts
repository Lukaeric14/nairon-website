	...
	},
	{
		...
		applyForm: [
			...
			},
			{
				...
				type: "url",
				placeholder: "https://traces.com/s/...",
				hint: "Paste the coding-agent session transcript you are most proud of: a feature, bug fix, or focused project task that shows how you think, plan, steer the agent, and verify the work.",
				fullWidth: true,
			},
			{
				key: "aiStack",
		...
		sections: [
			...
			},
			{
				...
				bullets: [
					...
					"A real traces.com session link showing the coding-agent session transcript you are most proud of",
					"Your full AI stack",
